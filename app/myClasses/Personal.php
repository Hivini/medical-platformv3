...
$masInfo = dbConnection::select(["*"], "medicos", [["id_usuario", logData::getData("id_usuario")]]);
    ...
    if(isset($_GET['type']))
    {
        if($_GET['type']=="doctors")
        {
            $citasRegistradas = dbConnection::select(["id_medico"], "citas", [["fecha_hora", "NOW", ">"]]);
        }
    }
?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <IMG SRC="/dataSource/img/HealthCare.png" WIDTH=120 HEIGHT=37 ALT="Plataforma médica">  
                </a>
            </div>
            <!-- /.navbar-header -->
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">Personal: Doctores. <?php var_dump("HOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOLAAAAAAAAAA"); ?></h1>
