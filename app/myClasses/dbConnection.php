<?php
    ...
    class dbConnection {
        ...
        private static function createInstance()
        {
            if(!is_a(self::$DBCon, "PDO"))
            {
                try
                {
                    ...
                    $user = "root";
                    $password = "";
		    self::$DBCon = new PDO('mysql:host=127.0.0.1; dbname='.$name, $user, $password, [PDO::MYSQL_ATTR_INIT_COMMAND =>"SET NAMES 'UTF8';"]);
         ...
         * @return void
         */ 
        public static function select(array $valores, $tabla, array $where = [], array $joins = [], $extra="")
        {
