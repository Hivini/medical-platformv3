...
$tabla="usuarios";
$where=[];
$join=[["pacientes", "usuarios.id_usuario","paciente.id_usuario"]];
  ...
  <body style="position:relative;width:21cm;height:29.7cm;margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;color:#001028;background-color:#FFFFFF;background-image:none;background-repeat:repeat;background-position:top left;background-attachment:scroll;font-family:Arial;font-size:12px;" >
    <div id="header" class="clearfix" style="padding-top:10px;padding-bottom:10px;padding-right:0;padding-left:0;margin-bottom:30px;" >
      ...
      <div id="project" style="float:left;" >
        <div style="white-space:nowrap;" ><span style="color:#5D6975;text-align:right;width:52px;margin-right:10px;display:inline-block;font-size:0.8em;" >Nombre</span><?$datos['nombre'];?></div>
        <div style="white-space:nowrap;" ><span style="color:#5D6975;text-align:right;width:52px;margin-right:10px;display:inline-block;font-size:0.8em;" >Apellido Paterno:</span><?$datos['apellidoPaterno'];?></div>
        <div style="white-space:nowrap;" ><span style="color:#5D6975;text-align:right;width:52px;margin-right:10px;display:inline-block;font-size:0.8em;" >Apellido Materno:</span> <?$datos['apellidoMaterno'];?></div>
        <div style="white-space:nowrap;" ><span style="color:#5D6975;text-align:right;width:52px;margin-right:10px;display:inline-block;font-size:0.8em;" >Correo:</span> <a href="mailto:"<?$datos['email'];?> style="color:#5D6975;text-decoration:underline;" ><?$datos['email'];?></a></div>
    ...
    <div>
      ...
      <div id="company" class="clearfix" style="float:left;text-align:left;" >
        <div style="white-space:nowrap;" >HealthCare</div>
        <div style="white-space:nowrap;" >Av.,<br /> .</div>
        <div style="white-space:nowrap;" >xxx-xxx-xxx</div>
        <div style="white-space:nowrap;" ><a href="mailto:mail@gmail.com" style="color:#5D6975;text-decoration:underline;" >mail@gmail.com</a></div>
      </div>
